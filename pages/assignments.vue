...
<div class="mt-4 md:mt-16 md:flex">
    <Table class=" md:ml-16 md:basis-4/5">
        ...
        <tr class="border ">
          ...
          <TableData>
            <div class="inline-flex">
            <div class="mr-6 font-bold text-blue-500 hover:text-blue-300"> <nuxt-link to="edit-assignment">Edit </nuxt-link></div> <div class="font-bold text-red-500 hover:text-red-300"> <nuxt-link>Delete </nuxt-link></div>
          </div>
          </TableData>
        </tr>
